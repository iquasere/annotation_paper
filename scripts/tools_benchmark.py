...
prokka_df = pd.merge(blast_consensus(f'{out}/prokka_genomes/PROKKA_01032022.blast'), uniprotinfo, on='Entry', how='left')   # must run: diamond blastp -d ann_paper/proteomes.dmnd -q ann_paper/prokka_genomes/PROKKA_01032022.faa -o ann_paper/prokka_genomes/PROKKA_01032022.blast --very-sensitive -p 15
